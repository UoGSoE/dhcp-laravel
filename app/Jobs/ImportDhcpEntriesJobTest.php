...
class ImportDhcpEntriesJobTest implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if ($validator->fails()) {
            foreach ($validator->errors()->toArray() as $errorKey => $errorMsg) {
                ...
                Log::info("Validation failed for DHCP entry {$failedDhcpEntry['dhcpEntryId']} : {$failedDhcpEntry['errorMessage']}");
