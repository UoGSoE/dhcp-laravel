@if (array_key_exists($dhcpEntry->id, $editedEntries))
    <input
        ...
        name="{{ $fieldName }}"
        id="{{ $fieldName }}"
        class="block w-full rounded-md border-0 py-1.5 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-base sm:leading-6"
    />
