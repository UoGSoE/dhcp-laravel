            ...
            <div>
                ...
                <div
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="header" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
                            DHCP Header
                        </label>
                    ...
                    {{-- Subnets --}}
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="subnets" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
                            DHCP Subnets
                        </label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                    ...
                    {{-- Groups --}}
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="groups" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
                            DHCP Groups
                        </label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                    ...
                    {{-- Footer --}}
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="footer" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
                            DHCP Footer
                        </label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
